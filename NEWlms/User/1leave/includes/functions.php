...
function createUser($conn, $SID, $username, $email, $password) {
    $sql = "INSERT INTO leave (	leave_Casual,leave_Sick,leave_Vacation,leave_Other) VALUES ($SID, $username, $email, $password);";
    $stmt = mysqli_stmt_init($conn);
