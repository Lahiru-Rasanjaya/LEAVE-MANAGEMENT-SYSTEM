...
<table  border="2" class="table1">
  ...
  <tr>
    ...
    <td> 
    <div class="input-box1">
              <input type="text" name="NC" class="input-box1A" placeholder="EX : 2" required>
         </div>
    </td>
    <td>
    <div class="input-box1">
              <input type="text" name="NS" class="input-box1B" placeholder="EX : 1" required>
         </div>
    </td>
    <td>
    <div class="input-box1">
              <input type="text" name="NV" class="input-box1C" placeholder="EX : 0" required>
         </div>
    </td>
    <td >
    <div class="input-box1">
              <input type="text" name="NO" class="input-box1D" placeholder="EX : 3" required>
         </div>
    </td>
  </tr>
    ...
    <div class="input-box5">
            ...
            <div class="input-box6">
                <p>
                    ...
                    <textarea  rows="10" cols="100"  form="usrform"  class="text1"  name="RFL"></textarea>
                </p>
            </div>
</br></br>
            <div class="input-box7">
                <p>
                    ...
                    <textarea rows="10" cols="100" name="AWOL" form="usrform" class="text1" ></textarea>
            </div>
