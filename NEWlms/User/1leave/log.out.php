      ...
      <div class="input-box5">
              ...
              <div class="input-box6">
                  <p>
                      ...
                      <textarea  name="RFLO" form="usrform" class="TBTout" readonly > <?php if(isset($_POST['RFL'])){echo $_POST['RFL'];}?> </textarea>
                  </p>
              </div>
  </br>
              <div class="input-box7">
                  <p>
                      ...
                      <textarea  name="AWOLO" form="usrform" class="TBTout" readonly></textarea>
                  </p>    
              </div>
