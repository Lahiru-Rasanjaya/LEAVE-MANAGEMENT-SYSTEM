...
<ul>
  <li style="float:right" class="logoutt"><a href="http://localhost/NEWlms/Admin/login.php"><span class="icon">
  <ion-icon name="person-outline"></ion-icon></span>Logout</a></li>
  <li style="float:left" class="pnewRegistration"><a href="approvedList.php"><span class="icon">Approved List</a></li> 
            ...
            <div class="card mt-5">
                <table class="tableDB1"border="2">
                            ...
                            <?php 
                               ...
                               $query = "SELECT * FROM leaves WHERE approval='2' "; 
                            ...
                            ?>
                                    ...
                                    <tr class="tableDB1td2">
                                        ...
                                        <td class="tableDB1ED"   align="center">
                                                    ...
                                                    <button type="submit" class="TDBedit" name="DBedit"><a href='ApprovedVied.php?
