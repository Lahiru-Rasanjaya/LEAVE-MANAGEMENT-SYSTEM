...
<!-- 
     ...
     if(isset($_SESSION['email']))
     {
       ...
       <div class="input-box1">
                 <input type="text" name="NCO" class="TBout" value="<?php if(isset($_POST['NC'])){echo $_POST['NC'];}?>" readonly>
            </div>
       </td>
       <td>
       <div class="input-box1">
                 <input type="text" name="NSO" class="TBout" value="<?php if(isset($_POST['NS'])){echo $_POST['NS'];}?>" readonly>
            </div>
       </td>
       <td>
       <div class="input-box1">
                 <input type="text" name="NVO" class="TBout" value="<?php if(isset($_POST['NV'])){echo $_POST['NV'];}?>" readonly>
            </div>
       </td>
       <td >
       <div class="input-box1">
                 <input type="text" name="NOO" class="TBout" value="<?php if(isset($_POST['NO'])){echo $_POST['NO'];}?>" readonly>
            </div>
       </td>
     </tr>
   ...
   <table border="2" class="TDout">
    ...
    <tr>
      ...
      <div class="input-box3">    
                      <input type="text" name="DOFAO" class="TBDout" value="<?php if(isset($_POST['DOFA'])){echo $_POST['DOFA'];}?>"  readonly>
    ...
    <tr>
      ...
      <div class="input-box4">
                      <input type="text" name="DOCOLO" class="TBDout"  value="<?php if(isset($_POST['DOCOL'])){echo $_POST['DOCOL'];}?>"  readonly>
                  </div>
      </td>
    ...
    <tr>
      ...
      <div class="input-box5">
                      <input type="text" name="DORDO" class="TBDout" value="<?php if(isset($_POST['DORD'])){echo $_POST['DORD'];}?>"  readonly>
                  </div>
      </td>
              ...
              <div class="input-box6">
                  <p>
                      ...
                      <textarea  name="RFLO"  class="TBTout" readonly ><?php if(isset($_POST['RFL'])){echo $_POST['RFL'];}?> </textarea>
                  </p>
              </div>
  </br>
              <div class="input-box7">
                  <p>
                      ...
                      <textarea  name="AWOLO" class="TBTout" readonly><?php if(isset($_POST['AWOL'])){echo $_POST['AWOL'];}?></textarea>
                  </p>    
              </div>

            <div class="Oback">
                <button type="submit" class="backO" name="submitoutOE"><a href="log.php">BACK</a></button> 
            </div>
            <div class="Osubmit">
                   <button type="submit" class="submitO" name="submitoutO">SUBMIT</button> 
            </div>
