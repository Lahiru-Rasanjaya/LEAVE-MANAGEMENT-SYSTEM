...
?>
  ...
  <ul>
  <li style="float:right" class="logoutt"><a href="http://localhost/NEWlms/Admin/Accept.php"><span class="icon">
  <ion-icon name="person-outline"></ion-icon></span>Logout</a></li>
   <li style="float:left" class="pnewRegistration"><a href="#"><span class="icon">Registration</a></li> 
   <li style="float:left" class="newRegistration"><a href="http://localhost/NEWlms/Admin/dDisplay.php"><span class="icon">Dashboard</a></li> 
</ul>
