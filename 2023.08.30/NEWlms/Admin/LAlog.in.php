   ...
   <table border="2" class="TDout">
    ...
    <tr>
      ...
      <div class="input-box3">    
                      <input type="text" name="DOFAO" class="TBDout" value="<?= $row['date'];?>" readonly>
    ...
    <tr>
      ...
      <div class="input-box5">
         ...
         <form class="logout" action="acceptReject.php" method="POST">
            <div class="acceptend">
               <div class="accept">
                <button type="submit" class="accept" name="accept"><a href='acceptReject.php?
                                                    & uid=<?php echo $id ?>'>Accept</a></button> 
               </div>
               <div>
               <div class="reject">
